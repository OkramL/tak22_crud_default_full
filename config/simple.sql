...
--
-- Host: localhost:3306
-- Generation Time: Mar 14, 2023 at 01:03 PM
...
--
ALTER TABLE `simple`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mina olen oluline väli! I am an important field!', AUTO_INCREMENT=22;
